...
export class AddManyToHabitatAndFlightCall extends ethereum.Call {
  get inputs(): AddManyToHabitatAndFlightCall__Inputs {
    return new AddManyToHabitatAndFlightCall__Inputs(this);
  }

  get outputs(): AddManyToHabitatAndFlightCall__Outputs {
    return new AddManyToHabitatAndFlightCall__Outputs(this);
  }
}

export class AddManyToHabitatAndFlightCall__Inputs {
  _call: AddManyToHabitatAndFlightCall;

  constructor(call: AddManyToHabitatAndFlightCall) {
    this._call = call;
  }
...
export class AddManyToHabitatAndFlightCall__Outputs {
  _call: AddManyToHabitatAndFlightCall;
...
export class ClaimManyFromHabitatAndFlightCall extends ethereum.Call {
  get inputs(): ClaimManyFromHabitatAndFlightCall__Inputs {
    return new ClaimManyFromHabitatAndFlightCall__Inputs(this);
  }

  get outputs(): ClaimManyFromHabitatAndFlightCall__Outputs {
    return new ClaimManyFromHabitatAndFlightCall__Outputs(this);
  }
}

export class ClaimManyFromHabitatAndFlightCall__Inputs {
  _call: ClaimManyFromHabitatAndFlightCall;

  constructor(call: ClaimManyFromHabitatAndFlightCall) {
    this._call = call;
  }
...
export class ClaimManyFromHabitatAndFlightCall__Outputs {
  _call: ClaimManyFromHabitatAndFlightCall;
